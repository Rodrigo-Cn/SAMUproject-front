  ...
  remove(e) {
    if (e) {
      ...
      if (t) {
        ...
        c[t] = n.filter((o) => o.toastId !== e), !c[t].length && !De(t) && ne(t, false), He(), se(() => {
...
function lt(e) {
  const t = B(false), n = B(false), a = B(false), o = B(V.Enter), s = $({
    ...e,
...
var it = K({
  ...
  setup(e) {
    ...
    return () => d("div", P({
      ...
      innerHTML: e.content
    }) : e.content])]), (e.closeButton === void 0 || e.closeButton === true) && d(Ze, {
      theme: e.theme,
      closeToast: (m) => {
